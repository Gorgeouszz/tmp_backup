...
#                self.DAG.append(tmp)
    ...
    def is_valid_proof(cls, block, block_hash):
        ...
        """
        print("qqq",block_hash)
        print("www",block.compute_hash())
...
def consensus():
    ...
    if longest_chain:
        ...
        print("change of DAG length !!!!!!!:",len(blockchain.DAG))
        print("hash_  = ",blockchain.DAG[1].DAG[0].hash_)
        interrupt = True
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        return True
    return False
...
class add_DAGTX_test(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            print("pre1",PRE1.hash_,"pre2",PRE2.hash_)
            tx_data = "{u'content': u'"+tx_content+"', 'timestamp': "+str(time.time())+", u'author': u'sender',"+"u'pre1': u'"+PRE1.hash_+"',u'pre2': u'"+PRE2.hash_+"'}"
            ...
            print("new_tx",tx_content)
            print("pre1",tx_data_['pre1'])
            print("pre2",tx_data_['pre2'])
            print("Genesis_port",blockchain.DAG[0].DAG[0].hash_)
            ...
            peers = [peer1]
            print("chain len : ",len(blockchain.chain))
            for i in peers:
